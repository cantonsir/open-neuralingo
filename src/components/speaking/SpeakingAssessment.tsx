...
export default function SpeakingAssessment() {
    return (
        <div className="flex-1 p-8 bg-gray-50 dark:bg-gray-950 flex flex-col items-center justify-center text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Speaking Assessment</h2>
            <p className="text-gray-500 dark:text-gray-400 max-w-md">
                Test your speaking skills with an interactive conversation exam.
            </p>
