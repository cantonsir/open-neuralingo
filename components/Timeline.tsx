...
const Timeline: React.FC<TimelineProps> = ({ duration, currentTime, markers, onSeek }) => {
  ...
  return (
    <div 
      className="relative h-12 w-full bg-gray-900 mt-4 rounded-md cursor-pointer group"
      onClick={(e) => {
    ...
    >
      {/* Progress Bar */}
      <div 
        className="absolute top-0 left-0 h-full bg-gray-800 transition-all duration-200"
